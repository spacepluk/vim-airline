...
let s:N2 = [ '#9e9e9e' , '#4e4e4e' , 247 , 239 ] " gray8          & gray2
let s:N3 = [ '#ffffff' , '#303030' , 231 , 236 ] " white          & gray4

" Insert mode                                    " fg             & bg
let s:I1 = [ '#ffffff' , '#0087af' , 231  , 31 ] " darkestcyan    & white
...
let g:airline#themes#xoria256#palette.visual = {
      \ 'airline_a': [ s:V1[0]   , s:V1[1]   , s:V1[2]   , s:V1[3]   , ''     ] }

let g:airline#themes#xoria256#palette.replace = copy(airline#themes#xoria256#palette.normal)
let g:airline#themes#xoria256#palette.replace.airline_a = [ s:RE[0] , s:RE[1] , s:RE[2] , s:RE[3] , '' ]


let s:IA = [ s:N2[1] , s:N3[1] , s:N2[3] , s:N3[3] , '' ]
let g:airline#themes#xoria256#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
